                ...
                <Drawer variant="permanent" open={open} className="drawer" id="desktop-only">
                    <Box className="sidebar-bg">
                        <Box className="w100 fx_c">
                            <Image src={open ? logo : smlogo} alt="Logo" className={open ? "lglogo" : "smlogo"} width={open ? 200 : 50} height={open ? 60 : 50} />
                        </Box>
                ...
                <Box component="main" sx={{ flexGrow: 1 }}>
                    <AppBar position="sticky" id="header">
                        <Toolbar className="fx_sb">
                            ...
                            <Box id="mobile-only">
                                <Image src={logo} alt="Logo" className="mobile-logo" width={150} height={45} />
                            </Box>
